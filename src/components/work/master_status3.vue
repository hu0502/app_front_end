<template>
  <div class="master_status3">
    <mt-header title="雇主超时任务">
...
export default {
  ...
  methods: {
    ...
    getUsersWork: function() {
      ...
      var url = "http://127.0.0.1:3000/api/mission/master_status3";
     // var url = "http://39.107.97.203:3000/api/mission/master_status3";
